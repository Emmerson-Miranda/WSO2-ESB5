...
public class TryMediator extends AbstractListMediator {
	...
	public boolean mediate(MessageContext synCtx) {
		...
		if (synLog.isTraceOrDebugEnabled()) {
			synLog.traceOrDebug("Start : Try mediator");
		...
		boolean result = true;
		if (execute) {
			synLog.traceOrDebug("Try - executing child mediators");
			...
			synLog.traceOrDebug("Try - skiping children execution");
		}
		synLog.traceOrDebug("End : Try mediator");
	...
	public boolean mediate(MessageContext synCtx, ContinuationState continuationState) {
		...
		if (synLog.isTraceOrDebugEnabled()) {
			synLog.traceOrDebug("Try mediator : Mediating from ContinuationState");
		}
